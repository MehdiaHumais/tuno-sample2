                                ...
                                <div className='col col-lg-12 col-12'>
                                    <div className="tp-blog-content">
                                        <div className="post format-standard-image">
                                            ...
                                            <h2>{title}</h2>
                                            <p>Responsive web design is essential for creating websites that provide a good user experience across various devices. This blog will dive into how CSS media queries work, how to implement flexible layouts, and tips for optimizing websites for mobile, tablet, and desktop viewing.</p>
